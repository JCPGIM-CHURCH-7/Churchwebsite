...
export default function HomePage() {
  ...
  const ministries = [
    ...
    },
    {
      ...
      ageGroup: "Women",
      icon: <User className="w-12 h-12 text-white opacity-80" />,
    },
    {
      ...
      ageGroup: "Men",
      icon: <UserCheck className="w-12 h-12 text-white opacity-80" />,
    },
    {
      ...
      ageGroup: "Ages 3-12",
      icon: <Baby className="w-12 h-12 text-white opacity-80" />,
    },
  ]
...
<section className="py-12 bg-white">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="text-center mt-4">
      <a
        href="https://youtube.com/live/IjriS_pdPTU?feature=share"
        target="_blank"
